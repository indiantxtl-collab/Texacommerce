...
import { rateLimitAuth, resetRateLimit } from "@/app/api/utils/rateLimiter";
import { getClientIP, validateEmail } from "@/app/api/utils/security";
import { sanitizeInput } from "@/app/api/utils/encryption";

export async function POST(request) {
  try {
    // Rate limiting
    const clientIP = getClientIP(request);
    const rateLimit = rateLimitAuth(clientIP);
